    ...
    <Header/>
      <div className='container mt-5'>
        ...
        <div className='text-center mt-5'>
            <img width={'25%'} height={'250px'} src="https://assets.materialup.com/uploads/16e7d0ed-140b-4f86-9b7e-d9d1c04edb2b/preview.png" alt="" />
            <h1 className='mt-3 text-danger'>Your Cart is Empty</h1>
